...
from spike import PrimeHub, LightMatrix, Button, Motor, DistanceSensor
...
# Programa Principal
distancia = DistanceSensor("D")
primeHub = PrimeHub()
display = LightMatrix()
motor = Motor("B")

distancia.light_up_all()
...
huskyLens.setCustomName("<Objeto>", 1)
